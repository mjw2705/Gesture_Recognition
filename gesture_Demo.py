...
gesture_session = onnxruntime.InferenceSession('models/gesture_model.onnx', None)
...
while cap.isOpened():
    ...
    if results.pose_landmarks is None:
        ...
        image.flags.writeable = False
        joint, abs_joint, label = utils.hand(img_roi, offset=(sx, sy))
        image.flags.writeable = True
